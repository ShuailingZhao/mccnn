...
for _, dataset in ipairs({2012, 2015}) do
   ...
   for i = 1,n_tr do
      ...
      print("before remove_nonvisible\n")
      adcensus.remove_nonvisible(disp)
      print("after remove_nonvisible\n")
      adcensus.remove_occluded(disp)
      print("after remove_occluded\n")
      adcensus.remove_white(x0[{{i}}]:cuda(), disp)
      print("after remove_white\n")
      disp = disp:float()
